...
public class Rescue_Field_Activity extends AppCompatActivity {
    ...
    String url = "http://10.255.138.57:4000/api/volunteers/rescue";
        ...
        apiService.uploadImage(imagePart).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(Rescue_Field_Activity.this, "Image uploaded successfully!", Toast.LENGTH_SHORT).show();
                    Log.d("UPLOAD", "Response: " + response.message());
                } else {
                    Toast.makeText(Rescue_Field_Activity.this, "Upload failed: " + response.code(), Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(Rescue_Field_Activity.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
